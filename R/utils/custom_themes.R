...
# date: "10/1/2019"
# original author of this document is @Z3tt (Cedric Scherer: cedricphilippscherer@gmail.com)
...
theme_custom <- function (base_size = 12, base_family = base, half_line = base_size/2)
{
