...
co2_plot <- co2_over_year %>%
  ...
  scale_x_discrete(limits=2013:2021, expand = expand_scale(mult = c(0, 0), 
                                         add = c(0.5, 1.6))) +
  guides(color=FALSE) +
  theme_bw(base_family = "dosis") + theme(plot.title = element_markdown(size = 15, hjust = 0, face="bold"),
                                    plot.subtitle = element_text(lineheight = 1),
                                    plot.margin=unit(c(10,10,10,10), "mm")) +
  transition_reveal(along = year) +
  ease_aes('linear') +
  labs(title = "<img src='img/car.png' height='16'></img> Tailpipe Carbon Dioxide Emission Average, 2013-2020",
...
```{r saveplot}
anim <- animate(co2_plot, fps = 30, duration = 10, width = 600, height = 600, end_pause = 10, type = "cairo")
